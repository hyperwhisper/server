...
<template>
  <aside
    v-if="isAdmin"
    class="fixed right-0 top-0 h-screen w-16 pt-20 border-l border-neutral-200 dark:border-white/10 bg-white dark:bg-black z-40 flex flex-col items-center py-4"
  >
