    ...
    typeText(demoTexts[currentTextIndex.value], () => {
      setTimeout(() => {
        currentTextIndex.value =
          (currentTextIndex.value + 1) % demoTexts.length;
        cycleTexts();
      }, 3000);
    });
  }, 2000);
...
<template>
  <div
    class="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-white overflow-hidden transition-colors duration-300"
  >
    <!-- Cracked wall texture background -->
    <svg
      class="fixed inset-0 w-full h-full pointer-events-none opacity-[0.25] dark:opacity-[0.35] z-50"
    ...
    <main class="relative">
      <!-- Hero Section -->
      <section
        class="min-h-screen flex flex-col items-center justify-center px-4 pt-16 relative"
      >
        <!-- Abstract Logo/Icon -->
        <div class="relative mb-8 sm:mb-12">
          <div class="w-24 h-24 sm:w-32 sm:h-32 relative">
            <!-- Subtle glow -->
            <div
              class="absolute inset-0 rounded-full bg-neutral-300/50 dark:bg-white/10 blur-2xl"
            />
            <svg viewBox="0 0 100 100" class="w-full h-full relative z-10">
              ...
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    class="[stop-color:theme(colors.neutral.700)] dark:[stop-color:#e5e5e5]"
                    style="stop-opacity: 1"
                  />
                  <stop
                    offset="100%"
                    class="[stop-color:theme(colors.neutral.400)] dark:[stop-color:#737373]"
              ...
              >
                <path
                  d="M20 50 Q20 30, 30 30 Q40 30, 40 50 Q40 70, 30 70 Q20 70, 20 50"
                  opacity="0.4"
                />
                <path
                ...
                />
                <path
                  d="M50 50 Q50 20, 70 20 Q90 20, 90 50 Q90 80, 70 80 Q50 80, 50 50"
                  opacity="1"
                />
              </g>
            </svg>
        ...
        <!-- Main Headline -->
        <h1
          class="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-center mb-4 sm:mb-6"
        >
        ...
        <div class="text-center mb-8 sm:mb-12">
          <p
            class="text-lg sm:text-xl text-neutral-600 dark:text-neutral-400 mb-1"
          >
            hyperwhisper
          </p>
          <p class="text-sm sm:text-base text-neutral-500">
            Open source AI-powered voice to text
          </p>
        </div>
        ...
        <div class="max-w-2xl mx-auto mb-10 sm:mb-14 px-4 w-full">
          <div
            class="relative rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm"
          >
            <!-- Main text area -->
            <div
              class="relative p-4 sm:p-6 min-h-[5rem] sm:min-h-[6rem] bg-neutral-100 dark:bg-neutral-800/50"
            >
              <!-- Listening Waveform Animation -->
              <div
                v-if="isListening"
                class="flex items-center justify-center h-[3rem] sm:h-[4rem] gap-[1px] w-full"
              >
                <div
              ...
              <p
                v-else
                class="text-base sm:text-lg text-neutral-700 dark:text-neutral-200 min-h-[3rem] sm:min-h-[4rem] text-center pb-6"
              >
                {{ demoText
                }}<span
                  v-if="isTyping"
                  class="inline-block w-0.5 h-5 bg-neutral-900 dark:bg-white ml-0.5 animate-pulse"
                />
              </p>
              <!-- Copy button -->
              <button
            ...
            <!-- Bottom bar -->
            <div
              class="flex items-center justify-between px-4 py-2.5 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700/50"
            >
              <div
        ...
        <!-- Mac & Windows Banner -->
        <div
          class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900"
        >
          <Apple class="size-4 text-neutral-400" />
          <Monitor class="size-4 text-neutral-400" />
          <span class="text-sm text-neutral-500 dark:text-neutral-400"
            >Mac & Windows support coming soon</span
          >
        </div>
      </section>
      ...
      <!-- Features Section -->
      <section
        class="py-20 sm:py-32 border-t border-neutral-200 dark:border-neutral-800"
      >
        <div class="container mx-auto px-4">
          <div class="grid sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto">
            <div class="text-center sm:text-left">
              <div
                class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-neutral-100 dark:bg-neutral-800 mb-4"
              >
                <svg
              ...
              <h3
                class="text-base font-medium mb-2 text-neutral-900 dark:text-white"
              >
                Hyper Accurate
              </h3>
              <p class="text-sm text-neutral-500 dark:text-neutral-400">
                Powered by state-of-the-art AI models. Understands accents,
                jargon, and context.
              </p>
            </div>
            <div class="text-center sm:text-left">
    ...
    <footer class="border-t border-neutral-200 dark:border-white/5 py-8">
      <div
        class="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-neutral-500 dark:text-neutral-600"
      >
        ...
        <div class="flex items-center gap-6">
          <a
            ...
            target="_blank"
            rel="noopener"
            class="hover:text-neutral-700 dark:hover:text-neutral-400 transition-colors"
          >
            GitHub
          </a>
          <NuxtLink
